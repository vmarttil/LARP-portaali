...
| 31052020 | 2,0 | Toteutettu käyttäjän profiilitietojen tallennus kryptattuna backendissa |
|          | 4,0 | Refaktoroitu koodia (mm. .then -> async/await) |
| 09012021 | 3,0 | Vaihdettu tietokanta MySQL:stä PostgreSQL:ään, määritelty tietokantarakenne uusiksi |
|          | 2,5 | Refaktoroitu backendin koodia yksinkertaisemmaksi |
...
| 20012021 | 3,0 | Toteutettu käyttäjän tietojen päivitys backendissa |
|          | 1,0 | Refaktoroitu backendia |
|          | 2,0 | Tutustuttu uudelleen frontendin koodiin |
...
| 06022021 | 3,0 | Tehty kokeiluja eri tavoista muodostaa lomakkeet |
|          | 1,0 | Ennakoivaa perehtymistä react-beautiful-dnd-kirjastoon |
|          | 3,0 | Refaktoroitu rekisteröitymis- ja sisäänkirjauslomakkeet |
|          | 2,0 | Koodattu käyttäjäprofiilin muokkaussivu melkein valmiiksi käyttäen uutta lomakkeiden käsittelytapaa |
...
| 21022021 | 8,0 | Backendin ja frontendin refaktorointi Sequelizen vaihtamiseksi node-pg-kirjastoon ja auki kirjoitettuihin SQL-kyselyihin | 
|          | 2,0 | API:n johdonmukaistamista |
...
| 28022021 | 5,0 | Front- ja backendiin pelin luontisivu |
|          | 4,0 | Front- ja backendiin omien pelien hallintasivu |
| 03032021 | 4,0 | Pelin tietojen muokkaussivun ja järjestäjien lisäyksen ja poiston toteutus frontendiin |
|          | 3,0 | Frontendin lomakkeiden ja ulkoasun refaktorointia |
| 06032021 | 4,0 | Ilmoittautumislomakkeiden tietokantarakenne valmis |
|          | 8,0 | Ilmoittautumislomakkeiden luonnin ja muokkauksen backend-toiminnallisuus tehty lähes valmiiksi ja testattu |
